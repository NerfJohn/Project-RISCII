...
/*
 * Class to hold data and functions related to "Load Address" function.
 *
 * Created from parser's output, the load addr item implements the functions
 * necessary to check and translate the given tokens into a 2 instruction
 * function. Class assumes it is the final owner of the given scan tokens.
 */
