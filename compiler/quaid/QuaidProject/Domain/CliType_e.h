...
typedef enum {
	...
	CLI_LOG_LEVEL,                     // sets log level during program run
	...
	CLI_HELP,                          // print help menu and exit
	CLI_VERSION,                       // print version info and exit

	// "Sentinel" values.
	CLI_FLAG_ARG_MAX  = CLI_LOG_LEVEL  // highest value "arg flag" ID
} CliType_e;
