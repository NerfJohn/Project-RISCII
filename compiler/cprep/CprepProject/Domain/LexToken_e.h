...
typedef enum {
	...
	TOKEN_LINE_TEXT,                 // line of source file contents
	TOKEN_LINE_FILE,                 // (possible) include file- takes full line
	TOKEN_KW_INCLUDE,                // "#include" keyword

	// Special values.
	TOKEN_INVALID,                   // Unknown/Invalid lex token
	TOKEN_LEX_MIN   = TOKEN_EOF,     // Lowest value lex token
