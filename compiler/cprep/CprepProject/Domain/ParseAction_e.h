...
typedef enum {
	...
	ACTION_FILE = TOKEN_LEX_MAX + 1,             // root of file being parsed
	ACTION_TEXT,                                 // non-preprocessor content
	ACTION_INCLUDE,                              // include directive

	// Special values.
	ACTION_INVALID,                              // Unknown/Invalid action
	ACTION_PARSE_MIN = ACTION_FILE,              // Lowest value action
